      ...
      <form onSubmit={handleSubmit(onSubmit)} className="m-4 p-4 w-full lg:w-2/3">
        <div className="grid grid-col-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="form-control">
            ...
            <input type="text" placeholder="AWB" className="input input-bordered" {...register("awbNumber", { required: true, minLength: 5 })} />
          </div>
          <div className="form-control">
            <label className="label p-1">
              <span className="label-text text-2xs">Reference</span>
            </label>
            <input type="text" placeholder="Reference" className="input input-bordered" {...register("referenceNumber", { minLength: 5 })} />
          </div>
          <div className="form-control">
            <label className="label p-1">
              <span className="label-text text-2xs">Booking Date</span>
            </label>
            <input type="datetime-local" placeholder="Booking Date" className="input input-bordered" {...register("bookedDate", { required: true, valueAsDate: true })} />
          </div>
          ...
          <div className="form-control">
            ...
            <select className="select select-bordered" {...register("courier", { required: true, valueAsNumber: true },)}>
          ...
          <div className="form-control">
            ...
            <input type="text" placeholder="Shipper Name" className="input input-bordered" {...register("shipperName", { minLength: 3 })} />
          </div>
          <div className="form-control">
            <label className="label p-1">
              <span className="label-text text-2xs">Origin</span>
            </label>
            <input type="text" placeholder="Origin" className="input input-bordered" {...register("origin", { minLength: 3 })} />
          </div>
          ...
          <div className="form-control">
            ...
            <select className="select select-bordered" {...register("doxType", { required: true, valueAsNumber: true })}>
          ...
          <div className="form-control">
            ...
            <input type="text" placeholder="Receiver Name" className="input input-bordered" {...register("receiverName", { minLength: 3 })} />
          </div>
          <div className="form-control">
            <label className="label p-1">
              <span className="label-text text-2xs">Destination</span>
            </label>
            <input type="text" placeholder="Destination" className="input input-bordered" {...register("destination", { required: true, minLength: 3 })} />
          </div>
          ...
          <div className="form-control">
            ...
            <select className="select select-bordered" {...register("shipmentMode", { required: true, valueAsNumber: true })}>
          ...
          <div className="form-control">
            ...
            <select className="select select-bordered" {...register("transportMode", { required: true, valueAsNumber: true })}>
          ...
          <div className="form-control">
            ...
            <select className="select select-bordered" {...register("coCourier", { valueAsNumber: true })}>
              <option disabled={true}>-- co courier --</option>
          ...
          <div className="form-control">
            ...
            <input type="number" placeholder="Booking Amount" className="input input-bordered" {...register("bookingAmount", { valueAsNumber: true })} />
          </div>
          <div className="form-control">
            <label className="label p-1">
              <span className="label-text text-2xs">Bill Amount</span>
            </label>
            <input type="number" placeholder="Bill Amount" className="input input-bordered" {...register("billAmount", { valueAsNumber: true })} />
          </div>
          <div className="form-control">
            <label className="label p-1">
              <span className="label-text text-2xs">Actual weight (Kg)</span>
            </label>
            <input type="number" placeholder="Actual weight" className="input input-bordered" {...register("actualWeight", { valueAsNumber: true })} />
          </div>
        ...
        <div className="modal-action">
          ...
          {loader && <button className="btn btn-accent loading">Saving...</button>}
